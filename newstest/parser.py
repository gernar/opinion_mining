        ...
        with codecs.open(data_path + '/' + file, 'r', 'utf-8') as f:
            ...
            for line in lines:
                ...
                if line[2] in objects:
                    ...
                    objects[line[2]] = 1
        subj = [key + ':' + str(subjects[key]) for key in subjects if (subjects[key] > 1 and key != '0')]
        obj = [key + ':' + str(objects[key]) for key in objects if (objects[key] > 1 and key != '0')]
